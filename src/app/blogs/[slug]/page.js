...
export default function BlogPage({ params }) {
  ...
  return <article>
    ...
    <div className="grid grid-col-12  lg:gap-8 sxl:gap-16 mt-8 px-5 md:px-10">
      <div className="col-span-12 lg:col-span-4">
        <details className="border-[1px] border-solid border-dark dark:border-light dark:text-light text-dark rounded-lg p-4 sticky top-6 max-h-[80vh] overflow-hidden overflow-y-auto" open>
